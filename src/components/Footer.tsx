    ...
    <footer className="footer">
      <div className="container footer-inner">
        <div className="footer-top">
          <div className="footer-col">
            <div className="footer-mark">
              <span className="mark-glyph serif">M</span>
              <span className="mono">miva / void</span>
            </div>
            <p className="footer-tag mono">
              Coder — это пространство кодера.<br />
              Инструменты, проекты и решения<br />
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><a href="#ecosystem">MIVA Systems</a></li>
              <li><a href="#ecosystem">CODER Market</a></li>
              <li><a href="#products">MIVA Studio</a></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><a href="#services">Что делаем</a></li>
              <li><a href="#approach">Подход</a></li>
              <li><a href="#why">Почему CODER</a></li>
        ...
        <div className="footer-bot">
          <span className="mono">© {y} · MIVA / CODER</span>
